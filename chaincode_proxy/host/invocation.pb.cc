  ...
  while (ptr < end) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::google::protobuf::io::ReadSize(ptr, &size);
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        ctx->extra_parse_data().SetFieldName("invocation.InvocationResponse.execution_response");
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) == (10 & 0xFF)) {
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            this->execution_response().data(), static_cast<int>(this->execution_response().length()),
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "invocation.InvocationResponse.execution_response"));
        } else {
          goto handle_unusual;
        }
        break;
